                        ...
                        <div className="flex items-center justify-between gap-4">
                            <div className="flex items-center gap-3 md:gap-6">
                                ...
                                <div className="hidden xs:block">
                                    ...
                                    <p className="text-stone-600 text-[10px] font-medium hidden md:block">Analyze side-by-side</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 md:gap-3">
                                ...
                                <Link to="/compare" className={`px-4 py-2.5 md:px-8 md:py-3.5 rounded-xl md:rounded-2xl font-black uppercase text-[9px] md:text-[10px] tracking-widest transition-all shadow-lg ${comparisonList.length >= 2 ? 'bg-primary-600 text-white shadow-primary-900/20' : 'bg-stone-800 text-stone-500 cursor-not-allowed opacity-50'}`}>
